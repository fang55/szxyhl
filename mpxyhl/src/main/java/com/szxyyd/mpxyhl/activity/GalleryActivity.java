...
import com.szxyyd.mpxyhl.zoo.PhotoView;
import com.szxyyd.mpxyhl.zoo.ViewPagerFixed;
...
public class GalleryActivity extends BaseActivity{
    ...
    private void initDetailImage(){
        ...
        for (int i = 0; i < Bimp.tempSelectBitmap.size(); i++) {
            ...
            PicassoUtils.loadImageViewHolder(this,imagePath,200,200,R.mipmap.teach,imageView);
